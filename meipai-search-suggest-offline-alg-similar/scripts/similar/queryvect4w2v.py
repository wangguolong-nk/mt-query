# -*- coding:utf-8 -*-
'''
输入：query.20170520(后边的编辑距离还得用)
辅助：vectors.bin.view，stopwords.dat
输出：query.w2v.20170520.vect
'''
import jieba
...
stopwordspath=projdatadir+'/dict/stopwords.dat'
w2v_model_vectors_path=projdatadir+'/model/vectors.bin.view'
