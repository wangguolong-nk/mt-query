...
query.sim.delta更新：用query.sim.20170520去更新query.sim.delta
'''
...
high_query_quality=projdatadir+'/work_data/search/query.predict.train.high.seg'
low_query_quality=projdatadir+'/work_data/search/query.predict.train.low.seg'
...
hvectstrpath=projdatadir+'/work_data/search/queryvect/query.w2v.vect.high'

assert len(date_arr)==1
hquery2vectdict={}
lquery2vectdict={}
for date in date_arr:
    lvectstrpath= datadir + '/query.w2v.'+date+'.vect'
...
for date in date_arr:
    lvectstrpath= datadir + '/query.w2v.'+date+'.vect'
    simoutpath=datadir+'/query.sim.'+date
    deletepath.append(simoutpath)
...
if os.path.exists(delta_querysimoutpath):
