...
for i in range(1,len(sys.argv)):
    ...
    if argk == '-deplydir':
        ...
        deleteFlag=int(argv)
if not deplydir:
    print 'need PARAMETER: deplydir!'
    sys.exit(1)
datadir=deplydir+'/work_data/sequential/daily'
    ...
    for filename in filenames:
        ...
        if not json_data:
            ...
            for key in cur_json:
                ...
                json_data[key]=val2
outjsonpath=deplydir+'/work_data/sequential/daily/full.query.sequential.model'
...
outviewpath=deplydir+'/work_data/sequential/daily/full.query.sequential.view'
high_quality_query_path=deplydir+'/work_data/search/query.predict.train.high.seg'
query2uids={}
